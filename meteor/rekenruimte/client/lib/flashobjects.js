...
// stage content:
    (lib.RekenRuimte = function() {
        ...
        // Laag 1
        this.instance = new lib.mcPlanet();
        this.instance.setTransform(409,223.1,1,1,0,0,0,0,-2.9);

        this.instance_1 = new lib.mcSpiral();
        this.instance_1.setTransform(322.1,48.4,1,1,0,0,0,11,25);

        this.instance_2 = new lib.mcRock();
        this.instance_2.setTransform(471.1,88,1,1,0,0,0,-0.9,0);

        this.instance_3 = new lib.mcRocketShip();
        this.instance_3.setTransform(84,302.1,1,1,0,0,0,1.6,-20);

        this.instance_4 = new lib.mcNotify();
        this.instance_4.setTransform(99,62,1,1,0,0,0,2,0.7);

        this.instance_5 = new lib.mcStar();
        this.instance_5.setTransform(421,59);

        this.instance_6 = new lib.mcMoon();
        this.instance_6.setTransform(301,325);

        this.spaceShip = new lib.mcSpaceShip();
        this.spaceShip.setTransform(275,123.1,1,1,0,0,0,0,1);

        this.addChild(this.spaceShip,this.instance_6,this.instance_5,this.instance_4,this.instance_3,this.instance_2,this.instance_1,this.instance);
...
// symbols:
    ...
    (lib.beam = function() {
        ...
        this.shape_90.graphics.lf(["#FFFF00","rgba(255,255,255,0)"],[0,1],0,-9.4,0,9.6).s().p("AgiBfIAAi9IBFAAIAAC9IhFAA").cp();
        this.shape_90.setTransform(3.6,9.6);
    ...
    (lib.SpaceShip2InCorrect = function() {
        ...
        this.shape_91.graphics.f().s("#000000").ss(4,0,1).p("AAgApQgGAGgHAEQgHAEgHgBQgVAAgOgNQgNgOAAgXQgBgNAEgLQAEgLAGgIQAHgHAJgEQAJgEAKAAQAHAAAHAEQAHAEAGAHQAGAIADALQADALABANQgBAMgDAJQgDAJgGAHIAAAA").cp();
        this.shape_91.setTransform(144.5,5.5);

        this.shape_92 = new cjs.Shape();
        this.shape_92.graphics.f().s("#000000").ss(4,0,1).p("AAyDcIhjm3");
        this.shape_92.setTransform(151,35);

        this.shape_93 = new cjs.Shape();
        this.shape_93.graphics.f("#FFFF00").s("#000000").ss(4,0,1).p("").cp();
        this.shape_93.setTransform(390.5,146.5);

        this.shape_94 = new cjs.Shape();
        this.shape_94.graphics.f("#FFFF00").s("#000000").ss(4,0,1).p("").cp();
        this.shape_94.setTransform(355.5,154.5);
        ...
        this.shape_95.setTransform(317.5,158.5);

        this.shape_96 = new cjs.Shape();
        this.shape_96.graphics.f("#FFFF00").s("#000000").ss(4,0,1).p("").cp();
        this.shape_96.setTransform(277.5,161.5);

        this.shape_97 = new cjs.Shape();
        this.shape_97.graphics.f("#FFFF00").s("#000000").ss(4,0,1).p("").cp();
        this.shape_97.setTransform(240.5,164.5);

        this.shape_98 = new cjs.Shape();
        this.shape_98.graphics.f("#FFFF00").s("#000000").ss(4,0,1).p("").cp();
        this.shape_98.setTransform(200.5,164.5);

        this.shape_99 = new cjs.Shape();
        this.shape_99.graphics.f().s("#000000").ss(4,0,1).p("").cp();
        this.shape_99.setTransform(214.5,82.7);

        this.shape_100 = new cjs.Shape();
        this.shape_100.graphics.f("#FFFF00").s("#000000").ss(4,0,1).p("").cp();
        this.shape_100.setTransform(160.5,162.5);

        this.shape_101 = new cjs.Shape();
        this.shape_101.graphics.f("#FFFF00").s("#000000").ss(4,0,1).p("").cp();
        this.shape_101.setTransform(121.5,158.5);

        this.shape_102 = new cjs.Shape();
        this.shape_102.graphics.f("#FFFF00").s("#000000").ss(4,0,1).p("").cp();
        this.shape_102.setTransform(44.5,142.5);

        this.shape_103 = new cjs.Shape();
        this.shape_103.graphics.f("#FFFF00").s("#000000").ss(4,0,1).p("").cp();
        this.shape_103.setTransform(84.5,152.5);
        ...
        this.shape_104.graphics.f("#0099CC").s("#000000").ss(4,0,1).p("").cp();
        this.shape_104.setTransform(214.5,82.7);

        this.shape_105 = new cjs.Shape();
        this.shape_105.graphics.f("#FF0000").s("#000000").ss(4,0,1).p("").cp();
        this.shape_105.setTransform(217.9,119);

        this.shape_106 = new cjs.Shape();
        this.shape_106.graphics.f("#990000").s("#000000").ss(4,0,1).p("").cp();
        this.shape_106.setTransform(216,135);

        this.addChild(this.shape_106,this.shape_105,this.shape_104,this.instance_1,this.shape_103,this.shape_102,this.shape_101,this.shape_100,this.shape_99,this.shape_98,this.shape_97,this.shape_96,this.shape_95,this.shape_94,this.shape_93,this.shape_92,this.shape_91);
    }).prototype = p = new cjs.Container();
    ...
    (lib.SpaceShip2Correct = function() {
        ...
        this.shape_107.graphics.f().s("#000000").ss(4,0,1).p("AAgApQgGAGgHAEQgHAEgHgBQgVAAgOgNQgNgOAAgXQgBgNAEgLQAEgLAGgIQAHgHAJgEQAJgEAKAAQAHAAAHAEQAHAEAGAHQAGAIADALQADALABANQgBAMgDAJQgDAJgGAHIAAAA").cp();
        this.shape_107.setTransform(144.5,5.5);

        this.shape_108 = new cjs.Shape();
        this.shape_108.graphics.f().s("#000000").ss(4,0,1).p("AAyDcIhjm3");
        this.shape_108.setTransform(151,35);

        this.shape_109 = new cjs.Shape();
        this.shape_109.graphics.f("#FFFF00").s("#000000").ss(4,0,1).p("").cp();
        this.shape_109.setTransform(390.5,146.5);

        this.shape_110 = new cjs.Shape();
        this.shape_110.graphics.f("#FFFF00").s("#000000").ss(4,0,1).p("").cp();
        this.shape_110.setTransform(355.5,154.5);

        this.shape_111 = new cjs.Shape();
        this.shape_111.graphics.f("#FFFF00").s("#000000").ss(4,0,1).p("").cp();
        this.shape_111.setTransform(317.5,158.5);

        this.shape_112 = new cjs.Shape();
        this.shape_112.graphics.f("#FFFF00").s("#000000").ss(4,0,1).p("").cp();
        this.shape_112.setTransform(277.5,161.5);

        this.shape_113 = new cjs.Shape();
        this.shape_113.graphics.f("#FFFF00").s("#000000").ss(4,0,1).p("").cp();
        this.shape_113.setTransform(240.5,164.5);

        this.shape_114 = new cjs.Shape();
        this.shape_114.graphics.f("#FFFF00").s("#000000").ss(4,0,1).p("").cp();
        this.shape_114.setTransform(200.5,164.5);

        this.shape_115 = new cjs.Shape();
        this.shape_115.graphics.f().s("#000000").ss(4,0,1).p("").cp();
        this.shape_115.setTransform(214.5,82.7);

        this.shape_116 = new cjs.Shape();
        this.shape_116.graphics.f("#FFFF00").s("#000000").ss(4,0,1).p("").cp();
        this.shape_116.setTransform(160.5,162.5);

        this.shape_117 = new cjs.Shape();
        this.shape_117.graphics.f("#FFFF00").s("#000000").ss(4,0,1).p("").cp();
        this.shape_117.setTransform(121.5,158.5);

        this.shape_118 = new cjs.Shape();
        this.shape_118.graphics.f("#FFFF00").s("#000000").ss(4,0,1).p("").cp();
        this.shape_118.setTransform(44.5,142.5);

        this.shape_119 = new cjs.Shape();
        this.shape_119.graphics.f("#FFFF00").s("#000000").ss(4,0,1).p("").cp();
        this.shape_119.setTransform(84.5,152.5);
        ...
        this.shape_120.graphics.f("#0099CC").s("#000000").ss(4,0,1).p("").cp();
        this.shape_120.setTransform(214.5,82.7);

        this.shape_121 = new cjs.Shape();
        this.shape_121.graphics.f("#006600").s("#000000").ss(4,0,1).p("").cp();
        this.shape_121.setTransform(217.9,119);
        ...
        this.shape_122.setTransform(216,135);

        this.addChild(this.shape_122,this.shape_121,this.shape_120,this.instance_2,this.shape_119,this.shape_118,this.shape_117,this.shape_116,this.shape_115,this.shape_114,this.shape_113,this.shape_112,this.shape_111,this.shape_110,this.shape_109,this.shape_108,this.shape_107);
    }).prototype = p = new cjs.Container();
    p.nominalBounds = new cjs.Rectangle(0,0,432.1,179.1);
    ...
    (lib.SpaceShip2 = function() {
        ...
        this.shape_123.graphics.f().s("#000000").ss(4,0,1).p("AAgApQgGAGgHAEQgHAEgHgBQgVAAgOgNQgNgOAAgXQgBgNAEgLQAEgLAGgIQAHgHAJgEQAJgEAKAAQAHAAAHAEQAHAEAGAHQAGAIADALQADALABANQgBAMgDAJQgDAJgGAHIAAAA").cp();
        this.shape_123.setTransform(144.5,5.5);

        this.shape_124 = new cjs.Shape();
        this.shape_124.graphics.f().s("#000000").ss(4,0,1).p("AAyDcIhjm3");
        this.shape_124.setTransform(151,35);

        this.shape_125 = new cjs.Shape();
        this.shape_125.graphics.f("#FFFF00").s("#000000").ss(4,0,1).p("").cp();
        this.shape_125.setTransform(390.5,146.5);

        this.shape_126 = new cjs.Shape();
        this.shape_126.graphics.f("#FFFF00").s("#000000").ss(4,0,1).p("").cp();
        this.shape_126.setTransform(355.5,154.5);

        this.shape_127 = new cjs.Shape();
        this.shape_127.graphics.f("#FFFF00").s("#000000").ss(4,0,1).p("").cp();
        this.shape_127.setTransform(317.5,158.5);
        ...
        this.shape_128.setTransform(277.5,161.5);

        this.shape_129 = new cjs.Shape();
        this.shape_129.graphics.f("#FFFF00").s("#000000").ss(4,0,1).p("").cp();
        this.shape_129.setTransform(240.5,164.5);

        this.shape_130 = new cjs.Shape();
        this.shape_130.graphics.f("#FFFF00").s("#000000").ss(4,0,1).p("").cp();
        this.shape_130.setTransform(200.5,164.5);

        this.shape_131 = new cjs.Shape();
        this.shape_131.graphics.f().s("#000000").ss(4,0,1).p("").cp();
        this.shape_131.setTransform(214.5,82.7);

        this.shape_132 = new cjs.Shape();
        this.shape_132.graphics.f("#FFFF00").s("#000000").ss(4,0,1).p("").cp();
        this.shape_132.setTransform(160.5,162.5);

        this.shape_133 = new cjs.Shape();
        this.shape_133.graphics.f("#FFFF00").s("#000000").ss(4,0,1).p("").cp();
        this.shape_133.setTransform(121.5,158.5);

        this.shape_134 = new cjs.Shape();
        this.shape_134.graphics.f("#FFFF00").s("#000000").ss(4,0,1).p("").cp();
        this.shape_134.setTransform(44.5,142.5);

        this.shape_135 = new cjs.Shape();
        this.shape_135.graphics.f("#FFFF00").s("#000000").ss(4,0,1).p("").cp();
        this.shape_135.setTransform(84.5,152.5);
        ...
        this.shape_136.graphics.f("#0099CC").s("#000000").ss(4,0,1).p("").cp();
        this.shape_136.setTransform(214.5,82.7);

        this.shape_137 = new cjs.Shape();
        this.shape_137.graphics.f("#333333").s("#000000").ss(4,0,1).p("").cp();
        this.shape_137.setTransform(217.9,119);

        this.shape_138 = new cjs.Shape();
        this.shape_138.graphics.f("#999999").s("#000000").ss(4,0,1).p("").cp();
        this.shape_138.setTransform(216,135);

        this.addChild(this.shape_138,this.shape_137,this.shape_136,this.instance_3,this.shape_135,this.shape_134,this.shape_133,this.shape_132,this.shape_131,this.shape_130,this.shape_129,this.shape_128,this.shape_127,this.shape_126,this.shape_125,this.shape_124,this.shape_123);
    }).prototype = p = new cjs.Container();
    p.nominalBounds = new cjs.Rectangle(0,0,432.1,179.1);
    ...
    (lib.spiralfxg = function() {
        ...
        this.shape_139.graphics.f().s("#FFFFFF").ss(8,0,1).p("");
        this.shape_139.setTransform(109.1,65.2);

        this.addChild(this.shape_139,this.Group_2);
    }).prototype = p = new cjs.Container();
    ...
    (lib.planet = function() {
        ...
        this.shape_140.graphics.f().s("#0099FF").ss(1.6,1,1).p("AE7rPQAPAAANAFQAMAFAKAKAKtjbIAUAyAJzm8IAACWAnGobIAAgoArAC0IAABQAFFFnIAUgBAEdHCQAKAFAKADADkKJQgBgCAAgCQgFAJgDAJQADgBADgBAEPJ8QgngDgqAWQATAIAKAAQgQAkABAV");
        this.shape_140.setTransform(5.5,8);

        this.shape_141 = new cjs.Shape();
        this.shape_141.graphics.f("#006600").s().p("").cp();
        this.shape_141.setTransform(1,6.5);

        // Laag 2
        this.shape_142 = new cjs.Shape();
        this.shape_142.graphics.f().s("#663300").ss(1.6,1,1).p("AIblnQAuAgAAAtAH5l6QgkgOgsAAAliooIAAAyAkcpGIAABkAkIp4ICCAAAsQgmIAAgsAsQA0IAAAiAmUGMQAAAZAYARQAXASAhAAAjCJ5Ih4hNIAyiWALVBCIA8BaAFhFpQgCAGgDAFAFFGSQgFADgFACAFqFJQABgHACgHIBjAAQA2gNAlAEQAABGheAyQheAyiEAAAD/B0QhDAAgvBGQguBGAABkIBGge");
        this.shape_142.setTransform(11.5,-3.5);

        this.shape_143 = new cjs.Shape();
        this.shape_143.graphics.f("#723900").s().p("").cp();
        this.shape_143.setTransform(-0.4,-2.9);
        ...
        this.shape_144.graphics.f().s("#0099FF").ss(1.6,1,1).p("AkAmoIAJCKIABAKAi/onIAHAPQBwHYGLDHQCMBdBIByIuNDSAoWnSQASAHACAXIBQDSAkIoYIAIBwAoCl4IAABa");
        this.shape_144.setTransform(16.5,28.8);

        this.shape_145 = new cjs.Shape();
        this.shape_145.graphics.f("#0099CC").s().p("").cp();
        this.shape_145.setTransform(-25.9,2);

        this.addChild(this.shape_145,this.shape_144,this.instance_5,this.shape_143,this.shape_142,this.shape_141,this.shape_140);
    }).prototype = p = new cjs.Container();
    ...
    (lib.mcRock = function() {
        ...
        this.shape_146.graphics.f("#000000").s().p("").cp();
        this.shape_146.setTransform(-41.6,-12.2);

        this.shape_147 = new cjs.Shape();
        this.shape_147.graphics.f("#000000").s().p("").cp();
        this.shape_147.setTransform(-48.5,-21.3);

        this.shape_148 = new cjs.Shape();
        this.shape_148.graphics.f("#000000").s().p("").cp();
        this.shape_148.setTransform(-44.2,-13.8);

        this.shape_149 = new cjs.Shape();
        this.shape_149.graphics.f("#000000").s().p("").cp();
        this.shape_149.setTransform(-36.3,6.7);

        this.shape_150 = new cjs.Shape();
        this.shape_150.graphics.f("#000000").s().p("").cp();
        this.shape_150.setTransform(19.1,-18.3);

        this.shape_151 = new cjs.Shape();
        this.shape_151.graphics.f("#000000").s().p("").cp();
        this.shape_151.setTransform(4.8,-49.3);

        this.shape_152 = new cjs.Shape();
        this.shape_152.graphics.f("#000000").s().p("").cp();
        this.shape_152.setTransform(-17.4,30.7);

        this.shape_153 = new cjs.Shape();
        this.shape_153.graphics.f("#000000").s().p("").cp();
        this.shape_153.setTransform(-58.1,-16.2);

        this.shape_154 = new cjs.Shape();
        this.shape_154.graphics.f("#000000").s().p("").cp();
        this.shape_154.setTransform(65.5,-29.3);

        this.shape_155 = new cjs.Shape();
        this.shape_155.graphics.f().s("#996633").ss(2,0,1).p("Ai+lxQhhAvBCB2QgsAegZArAjSiBIBaAAAmAkMQgCAhAHAeQALA1AjAsQAjAsA7AjAl8k3QgEAWAAAVAG2jbQgKBfAmALIgFBTAF6DFIgIiAAHKgaIgPBYIgCAPAHKAYIADg2AHKgaIAIhXAIkDvIjIA8ALbg9IAACyQAABYhBA+QhBA+hdAAAmQFxIilgPIilgPIGCigAo1FiIAcgVIjBAGAoZFNIBhhKAoZFNID2gI");
        this.shape_155.setTransform(11.2,-5.9);

        this.shape_156 = new cjs.Shape();
        this.shape_156.graphics.f("#996600").s().p("").cp();
        this.shape_156.setTransform(-9.9,1);

        // Laag 1
        this.instance_10 = new lib.rock("synched",0);
        this.instance_10.setTransform(-0.9,0,1,1,0,0,0,1.5,1.4);

        this.addChild(this.instance_10,this.shape_156,this.shape_155,this.shape_154,this.shape_153,this.shape_152,this.shape_151,this.shape_150,this.shape_149,this.shape_148,this.shape_147,this.shape_146);
    }).prototype = p = new cjs.Container();
    ...
    (lib.mcMoon = function() {
        ...
        this.shape_157.graphics.f("#FFFFFF").s("#FFCC33").ss(4,0,1).p("").cp();
        this.shape_157.setTransform(24.5,-25.9);
        ...
        this.shape_158.setTransform(-45.4,-25.9);

        this.face = new lib.mcFace();

        this.shape_159 = new cjs.Shape();
        this.shape_159.graphics.f("#006600").s().p("AAAgQQAAgCAAgBQAGADAGACQADAEACAEQACADABADQgBADgCAEQgCADgDAFQgGACgGADQgEgDgHgCQgDgFgFgDQAAgEAAgDQAAgDAAgDQAFgEADgEQAHgBAEgBIAAAA").cp();
        this.shape_159.setTransform(68,5);

        this.addChild(this.shape_159,this.face,this.shape_158,this.shape_157,this.leftEye,this.rightEye,this.nose,this.mouth);
    }).prototype = p = new cjs.Container();
    p.nominalBounds = new cjs.Rectangle(-88.9,-85.4,178.1,171.1);
    ...
    (lib.mcTextSpaceShipIncorrect = function() {
        ...
        // Laag 2
        this.instance_16 = new lib.mcBeam();
        this.instance_16.setTransform(349.3,142.1,1,1,0,0,0,3.6,9.6);

        this.instance_17 = new lib.mcBeam();
        this.instance_17.setTransform(194.9,152.5,1,1,0,0,0,3.6,9.6);

        this.instance_18 = new lib.mcBeam();
        this.instance_18.setTransform(115.7,146.9,1,1,0,0,0,3.6,9.6);

        this.instance_19 = new lib.mcBeam();
        this.instance_19.setTransform(38.9,132.5,1,1,0,0,0,3.6,9.6);

        this.instance_20 = new lib.mcBeam();
        this.instance_20.setTransform(271.9,150.5,1,1,0,0,0,3.6,9.6);
        ...
        // ship
        this.instance_21 = new lib.SpaceShip2InCorrect("synched",0);
        this.instance_21.setTransform(216,68.5,1,1,0,0,0,216,88.5);

        this.addChild(this.instance_21,this.inCorrectSpaceText,this.instance_20,this.instance_19,this.instance_18,this.instance_17,this.instance_16);
    }).prototype = p = new cjs.Container();
    ...
    (lib.mcTextSpaceShipCorrect = function() {
        ...
        // beamers
        this.instance_22 = new lib.mcBeam();
        this.instance_22.setTransform(349.3,142.1,1,1,0,0,0,3.6,9.6);

        this.instance_23 = new lib.mcBeam();
        this.instance_23.setTransform(194.9,152.5,1,1,0,0,0,3.6,9.6);

        this.instance_24 = new lib.mcBeam();
        this.instance_24.setTransform(115.7,146.9,1,1,0,0,0,3.6,9.6);

        this.instance_25 = new lib.mcBeam();
        this.instance_25.setTransform(38.9,132.5,1,1,0,0,0,3.6,9.6);

        this.instance_26 = new lib.mcBeam();
        this.instance_26.setTransform(271.9,150.5,1,1,0,0,0,3.6,9.6);
        ...
        // ship
        this.instance_27 = new lib.SpaceShip2Correct("synched",0);
        this.instance_27.setTransform(216,68.5,1,1,0,0,0,216,88.5);

        this.addChild(this.instance_27,this.correctSpaceText,this.instance_26,this.instance_25,this.instance_24,this.instance_23,this.instance_22);
    }).prototype = p = new cjs.Container();
    p.nominalBounds = new cjs.Rectangle(0,-19.9,432.1,218.8);
    ...
    (lib.mcTextSpaceShip = function() {
        ...
        // beamers
        this.instance_28 = new lib.mcBeam();
        this.instance_28.setTransform(349.3,142.1,1,1,0,0,0,3.6,9.6);

        this.instance_29 = new lib.mcBeam();
        this.instance_29.setTransform(194.9,152.5,1,1,0,0,0,3.6,9.6);

        this.instance_30 = new lib.mcBeam();
        this.instance_30.setTransform(115.7,146.9,1,1,0,0,0,3.6,9.6);

        this.instance_31 = new lib.mcBeam();
        this.instance_31.setTransform(38.9,132.5,1,1,0,0,0,3.6,9.6);

        this.instance_32 = new lib.mcBeam();
        this.instance_32.setTransform(271.9,150.5,1,1,0,0,0,3.6,9.6);
        ...
        // ship
        this.instance_33 = new lib.SpaceShip2("synched",0);
        this.instance_33.setTransform(216,68.5,1,1,0,0,0,216,88.5);

        this.addChild(this.instance_33,this.spaceText,this.instance_32,this.instance_31,this.instance_30,this.instance_29,this.instance_28);
    }).prototype = p = new cjs.Container();
    p.nominalBounds = new cjs.Rectangle(0,-19.9,432.1,218.8);
    ...
    (lib.mcTextRocketShip = function() {
        ...
        // Laag 2
        this.instance_34 = new lib.mcFlame();
        this.instance_34.setTransform(486,45,0.533,0.543,0,0,180,57,0);
        ...
        // ship
        this.instance_35 = new lib.RocketShip("synched",0);
        this.instance_35.setTransform(216,68.5,1,1,0,0,180,216,88.5);

        this.addChild(this.instance_35,this.rocketText,this.instance_34);
    }).prototype = p = new cjs.Container();
